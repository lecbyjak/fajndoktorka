...
navigationOrder: 50
sources:
  - label: "ČSSZ: Kdy a jak žádat o invalidní důchod (PDF)"
    url: "https://www.cssz.cz/documents/20143/99584/2025_kdy_a_jak_zadat_o_invalidni_duchod.pdf/02f947cb-a528-ff49-04c3-b26aab2f0cfe"
  - label: "ePortál ČSSZ: Žádost o důchod online"
    url: "https://eportal.cssz.cz/web/portal/-/sluzby/zadost-o-duchod"
---
...
Žádost o invalidní důchod lze podat elektronicky prostřednictvím služby **Žádost o důchod online** na ePortálu ČSSZ nebo ji s žadatelem sepíší na OSSZ. Pokud se kvůli nepříznivému zdravotnímu stavu nemůžete dostavit osobně, může za stanovených podmínek žádost podat také zmocněnec nebo rodinný příslušník. Aktuální postup a požadované doklady vždy ověřte v uvedených zdrojích ČSSZ.

## 3. Potřebné dokumenty:

- občanský průkaz, u cizinců pas či povolení k pobytu,
- doklady o studiu, popřípadě učení (i nedokončeném),
- doklady o výkonu vojenské nebo civilní služby,
- doklady prokazující péči o děti do 4 let věku a čestné prohlášení,
- potvrzení zaměstnavatele o vyplácených náhradách za ztrátu na výdělku po skončení pracovní neschopnosti náležející za pracovní úraz nebo nemoc z povolání,
- při výplatě důchodu na účet vyplněný a bankou potvrzený tiskopis „Žádost o zařízení výplaty důchodu poukazem na účet“,
- doklady prokazující zaměstnání v cizině,
- náhradní doklady k chybějícím dobám pojištění, například potvrzení zaměstnavatele, pracovní smlouvy nebo svědecká prohlášení,
- na výzvu OSSZ evidenční list důchodového pojištění a potvrzení zaměstnavatele dle § 83 odst. 2 zákona č. 582/1991 Sb.; zaměstnavatel je povinen tyto dokumenty při podání žádosti svého zaměstnance předložit.
