...
navigationOrder: 30
sources:
  - label: "MPSV: Příspěvek na péči"
    url: "https://mpsv.gov.cz/prispevek-na-peci"
  - label: "MPSV: Formuláře k příspěvku na péči"
    url: "https://mpsv.gov.cz/formulare?pos_id=28"
---
...
1. **Mobilita** – schopnost vstát z postele a ulehnout do ní, usedání a chůze.
2. **Orientace** – schopnost orientovat se pomocí zraku a sluchu.
3. **Komunikace** – schopnost dorozumět se pomocí řeči a písmem.
4. **Stravování** – schopnost najíst se, napít a dodržovat dietní režim.
5. **Oblékání a obouvání** – schopnost vybrat si vhodné oblečení a obuv a samostatně se obléknout a svléknout.
6. **Tělesná hygiena** – schopnost vykonávat základní osobní hygienu, například mytí rukou, sprchování, čištění zubů nebo česání.
7. **Výkon fyziologické potřeby** – schopnost samostatně dojít na toaletu, vyprázdnit se a provést očistu.
8. **Péče o zdraví** – schopnost dodržovat předepsaný léčebný režim, například užívat léky, měřit tlak nebo aplikovat inzulin.
9. **Osobní aktivity** – schopnost vykonávat aktivity přiměřené věku, například hrát si s dětmi nebo se scházet s přáteli.
10. **Péče o domácnost** – u osob starších 18 let schopnost nakupovat jídlo a základní potřeby, nakládat s penězi nebo nosit nákup.

Podle počtu životních potřeb, u nichž daný člověk potřebuje pomoc, jsou definovány 4 stupně závislosti.

Výše příspěvku závisí na věku osoby a přiznaném stupni závislosti. Příspěvek vyplácí krajská pobočka Úřadu práce. Protože se částky mohou měnit, ověřte aktuální výši v odkazu MPSV v části **Další zdroje**.
...
1. Podejte žádost na kontaktním pracovišti krajské pobočky Úřadu práce. Tiskopis lze získat na pracovišti nebo prostřednictvím aktuálního [formuláře MPSV](https://mpsv.gov.cz/formulare?pos_id=28).
2. Sociální pracovník provede sociální šetření a zjistí, jak samostatný je žadatel ve svém přirozeném prostředí.
3. Krajská pobočka Úřadu práce požádá příslušnou okresní správu sociálního zabezpečení o posouzení, zda žadatel splňuje podmínky závislosti a do kterého stupně patří.

### Okresní správa sociálního zabezpečení bude při tomto posouzení vycházet

- ze zdravotního stavu žadatele doloženého nálezem poskytovatele zdravotních služeb,
- z výsledku provedeného sociálního šetření,
- ze zjištěných potřeb osoby a případných výsledků funkčních vyšetření,
